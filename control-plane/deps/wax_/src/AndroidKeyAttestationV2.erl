...
%% Purpose: Encoding and decoding of the types in AndroidKeyAttestationV2.

-module('AndroidKeyAttestationV2').
-moduledoc false.
-compile(nowarn_unused_vars).
-dialyzer(no_improper_lists).
-dialyzer(no_match).
-include("AndroidKeyAttestationV2.hrl").
-asn1_info([{vsn,'5.5'},
            {module,'AndroidKeyAttestationV2'},
...
encode_disp('AndroidKeyAttestationV2', Data) -> enc_AndroidKeyAttestationV2(Data);
...
decode_disp('AndroidKeyAttestationV2', Data) -> dec_AndroidKeyAttestationV2(Data);
...
%%================================
%%  AndroidKeyAttestationV2
%%================================
enc_AndroidKeyAttestationV2(Val) ->
    enc_AndroidKeyAttestationV2(Val, [<<48>>]).

enc_AndroidKeyAttestationV2(Val, TagIn) ->
...
%%-------------------------------------------------
%% attribute softwareEnforced(7)   External AndroidKeyAttestationV2:AuthorizationList
%%-------------------------------------------------
   {EncBytes7,EncLen7} = 'enc_AuthorizationList'(Cindex7, [<<48>>]),

%%-------------------------------------------------
%% attribute teeEnforced(8)   External AndroidKeyAttestationV2:AuthorizationList
%%-------------------------------------------------
...
dec_AndroidKeyAttestationV2(Tlv) ->
   dec_AndroidKeyAttestationV2(Tlv, [16]).

dec_AndroidKeyAttestationV2(Tlv, TagIn) ->
   %%-------------------------------------------------
...
Res1 = {'AndroidKeyAttestationV2',Term1,Term2,Term3,Term4,Term5,Term6,Term7,Term8},
Res1.
...
{_,Cindex1,Cindex2,Cindex3,Cindex4,Cindex5,Cindex6,Cindex7,Cindex8,Cindex9,Cindex10,Cindex11,Cindex12,Cindex13,Cindex14,Cindex15,Cindex16,Cindex17,Cindex18,Cindex19,Cindex20,Cindex21,Cindex22,Cindex23,Cindex24,Cindex25,Cindex26,Cindex27,Cindex28,Cindex29,Cindex30,Cindex31} = Val,
...
%%-------------------------------------------------
%% attribute rootOfTrust(20)   External AndroidKeyAttestationV2:RootOfTrust OPTIONAL
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute attestationApplicationId(23) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes23,EncLen23} =  case Cindex23 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex23, [<<4>>,<<191,133,69>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdBrand(24) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes24,EncLen24} =  case Cindex24 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex24, [<<4>>,<<191,133,70>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdDevice(25) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes25,EncLen25} =  case Cindex25 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex25, [<<4>>,<<191,133,71>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdProduct(26) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes26,EncLen26} =  case Cindex26 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex26, [<<4>>,<<191,133,72>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdSerial(27) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes27,EncLen27} =  case Cindex27 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex27, [<<4>>,<<191,133,73>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdImei(28) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes28,EncLen28} =  case Cindex28 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex28, [<<4>>,<<191,133,74>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdMeid(29) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes29,EncLen29} =  case Cindex29 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex29, [<<4>>,<<191,133,75>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdManufacturer(30) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes30,EncLen30} =  case Cindex30 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex30, [<<4>>,<<191,133,76>>])
       end,

%%-------------------------------------------------
%% attribute attestationIdModel(31) with type OCTET STRING OPTIONAL
%%-------------------------------------------------
   {EncBytes31,EncLen31} =  case Cindex31 of
         asn1_NOVALUE -> {<<>>,0};
         _ ->
            encode_restricted_string(Cindex31, [<<4>>,<<191,133,77>>])
       end,

   BytesSoFar = [EncBytes1, EncBytes2, EncBytes3, EncBytes4, EncBytes5, EncBytes6, EncBytes7, EncBytes8, EncBytes9, EncBytes10, EncBytes11, EncBytes12, EncBytes13, EncBytes14, EncBytes15, EncBytes16, EncBytes17, EncBytes18, EncBytes19, EncBytes20, EncBytes21, EncBytes22, EncBytes23, EncBytes24, EncBytes25, EncBytes26, EncBytes27, EncBytes28, EncBytes29, EncBytes30, EncBytes31],
LenSoFar = EncLen1 + EncLen2 + EncLen3 + EncLen4 + EncLen5 + EncLen6 + EncLen7 + EncLen8 + EncLen9 + EncLen10 + EncLen11 + EncLen12 + EncLen13 + EncLen14 + EncLen15 + EncLen16 + EncLen17 + EncLen18 + EncLen19 + EncLen20 + EncLen21 + EncLen22 + EncLen23 + EncLen24 + EncLen25 + EncLen26 + EncLen27 + EncLen28 + EncLen29 + EncLen30 + EncLen31,
encode_tags(TagIn, BytesSoFar, LenSoFar).
...
[{131781,V23}|TempTlv24] ->
    {decode_octet_string(V23, [4]), TempTlv24};
    _ ->
        { asn1_NOVALUE, Tlv23}
end,
...
[{131782,V24}|TempTlv25] ->
    {decode_octet_string(V24, [4]), TempTlv25};
    _ ->
        { asn1_NOVALUE, Tlv24}
end,
...
case Tlv32 of
[] -> true;_ -> exit({error,{asn1, {unexpected,Tlv32}}}) % extra fields not allowed
end,
Res1 = {'AuthorizationList',Term1,Term2,Term3,Term4,Term5,Term6,Term7,Term8,Term9,Term10,Term11,Term12,Term13,Term14,Term15,Term16,Term17,Term18,Term19,Term20,Term21,Term22,Term23,Term24,Term25,Term26,Term27,Term28,Term29,Term30,Term31},
Res1.
