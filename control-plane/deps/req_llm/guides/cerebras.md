...
Use exact Cerebras IDs from [LLM Catalog](https://llmcatalog.dev) when possible. If you need to use a model ID before it lands in the registry, use `ReqLLM.model!/1`.
