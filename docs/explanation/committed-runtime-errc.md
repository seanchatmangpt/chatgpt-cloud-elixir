...
| Re-shipping sources git already transports | The autonomic capsule's `identity` profile binds all 63 sources by commit + tree SHA instead of carrying 395 MB of source archives. |
