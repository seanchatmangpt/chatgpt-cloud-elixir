...
mkdir -p "$STAGE/runtime/otp" "$STAGE/runtime/elixir" "$STAGE/home/mix" "$STAGE/home/hex" "$STAGE/home/rebar" "$STAGE/scripts/lib" "$STAGE/verifier" "$STAGE/source"
...
cp "$ROOT/scripts/lib/verify-capsule-common.sh" "$STAGE/scripts/lib/verify-capsule-common.sh"
